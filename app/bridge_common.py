...
OPENCLAW_POSTS_JSON_PATH = OPENCLAW_RUNTIME_DIR / "x_posts.json"
OPENCLAW_POSTS_TEXT_PATH = OPENCLAW_RUNTIME_DIR / "x_posts.txt"
OPENCLAW_MONITOR_STATE_PATH = OPENCLAW_RUNTIME_DIR / "x_monitor_state.json"
TRADE_DB_PATH = RUNTIME_DIR / "mirrorbot.db"
TRADE_SETTINGS_PATH = APP_DIR / "trade_settings.json"
X_TIMELINE_COOKIE_PATH = APP_DIR / "x_timeline_cookie.txt"
